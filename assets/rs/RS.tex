...
We also discovered infinite families of \emph{ties} in function field prime races, proving that for certain moduli $m$ and residue classes $a, b$, the counts $\pi(a, m, N)$ and $\pi(b, m, N)$ of monic irreducible polynomials of degree $N$ are equal for infinitely many $N$ \cite{bates2026ties}.
